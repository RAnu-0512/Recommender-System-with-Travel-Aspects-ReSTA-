...
def get_popular_spotinfo(allpref_spots_info):
    popular_spots_info_path = f"./data/popular_spots/popular_spots_final.csv"
    popular_spots_info = []
...
def get_pref_spot_info(pref):
    ...
    # ,...}
    spots_info = {}
    latlng_info_path = f"data/latlng/{pref}_latlng_review_exist_aspects.csv"
    major_path = f"data/major_miner/{pref}major_aspects.csv"
    miner_path = f"data/major_miner/{pref}miner_aspects.csv"
    ...
    aspect_folder_path = f"./data/aspects_and_vectors/{pref}/"
    read_aspectsVector_path = f"./data/spots_aspect_vector/{pref}aspectVector_fromCluster_GPT.csv"
    fastText_folder_path = f"./data/aspect_with_fastText_vector/{pref}/"
    ...
    #スポットの画像urlを読み込む
    image_url_path = f"./data/imageUrl/{pref}_imageUrl.csv" 
    ...
    aspects_label_folder_path = f"data/aspects_labels/{pref}/"
    for spot_name,spot_info in spots_info.items():
